  ...
  template: `<div class="layout-topbar">
    ...
    <div class="layout-topbar-actions">
      <div class="layout-config-menu">
        <div class="layout-topbar-locale">
          <button
            type="button"
            class="layout-topbar-locale-action"
            [disabled]="locale() === 'en'"
        ...
        <button type="button" class="layout-topbar-action" (click)="layoutService.toggleDarkMode()">
          <i
            [ngClass]="{
              pi: true,
...
export class ShellTopbar {
  ...
  // the pre-shell admin root component this replaces).
